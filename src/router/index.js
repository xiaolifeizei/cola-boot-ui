...
export const componentMap = {
  ...
  'basics_storehouse': () => import('@/views/basics/storehouse'),
  'basics_transit_company': () => import('@/views/basics/transitCompany'),
  'basics_truck': () => import('@/views/basics/truck'),
  'basics_workstation': () => import('@/views/basics/workstation'),
  'basics_assay_index': () => import('@/views/basics/assay/assayIndex'),
  'order_sale': () => import('@/views/order/sale'),
