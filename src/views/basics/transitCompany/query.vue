  ...
  <div class="query-content">
    <el-form ref="queryForm" :model="query.data" :inline="true">
      <el-form-item prop="name">
        <el-input v-model="query.data.name" :clearable="true" placeholder="请输入运输公司名称" />
      </el-form-item>
      <el-form-item prop="spellCode">
        <el-input v-model="query.data.spellCode" :clearable="true" placeholder="请输入运输公司名称拼音码" />
      </el-form-item>
