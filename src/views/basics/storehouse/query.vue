  ...
  <div class="query-content">
    <el-form ref="queryForm" :model="query.data" :inline="true">
      <el-form-item prop="name">
        <el-input v-model="query.data.name" :clearable="true" placeholder="请输入仓库名称" />
      </el-form-item>
      <el-form-item prop="code">
        <el-input v-model="query.data.code" :clearable="true" placeholder="请输入仓库编码" />
      </el-form-item>
